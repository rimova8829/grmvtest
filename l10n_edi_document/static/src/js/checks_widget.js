odoo.define('l10n_edi_document.checks_widget', function(require){
    'use strict';
    ...
    var ChecksWidget = AbstractField.extend({
        template: 'PaymentChecks',
        className: 'js_payment_checks',
        events: {
        ...
        get_html: function(){
            this._rpc({
                ...
                this.modal = Qweb.render('PaymentChecksModal',{ 'html_field': rendered_view});
...
field_registry.add('payments_checks', ChecksWidget);
return ChecksWidget;
});
