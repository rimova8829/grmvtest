...
* 2.1.9 (2022-04-04)
    ...
    - Fixed issue with printing multiple labels for users without Printnode / Manager role
    - Fixed compatibility of workstations devices feature with HR module
    - Fixed issue with wrong printer selected for default product label in Print Labels wizard
...
* 1.7.3 (2021-07-13)
    - Fixed issue with auto-test for purchase order flow and user access rights
...
* 1.2 (2020-07-28)
    -  Made Printer non-required in "Print action buttons" menu. If not defined, than printer will be selected
       based on user or company printer settings
